...
#
# Script generated by Vivado on Thu Mar 26 23:22:44 +0700 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : soc_riscv_v2.sh
...
#
# Usage        : soc_riscv_v2.sh
#                soc_riscv_v2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                soc_riscv_v2.sh [-reset_run]
#                soc_riscv_v2.sh [-reset_log]
#                soc_riscv_v2.sh [-help]
#
...
# script info
echo -e "soc_riscv_v2.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./soc_riscv_v2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb soc_riscv_v2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./soc_riscv_v2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: soc_riscv_v2.sh [-help]\n\
Usage: soc_riscv_v2.sh [-step]\n\
Usage: soc_riscv_v2.sh [-lib_map_path]\n\
Usage: soc_riscv_v2.sh [-reset_run]\n\
Usage: soc_riscv_v2.sh [-reset_log]\n\
Usage: soc_riscv_v2.sh [-keep_index]\n\
Usage: soc_riscv_v2.sh [-noclean_files]\n\n\
