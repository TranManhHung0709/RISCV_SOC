# 1 "E:\\Vivado_projects\\RISCV_SOC\\vitis_v2\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "E:\\Vivado_projects\\RISCV_SOC\\vitis_v2\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "E:\\Vivado_projects\\RISCV_SOC\\vitis_v2\\platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "E:\\Vivado_projects\\RISCV_SOC\\vitis_v2\\platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "E:\\Vivado_projects\\RISCV_SOC\\vitis_v2\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "E:\\Vivado_projects\\RISCV_SOC\\vitis_v2\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "soc_riscv_v2.bit.bin";
  clocking0: clocking0 {
  ...
  DMEM_0: axi_lutram_wrapper@60000000 {
   compatible = "xlnx,axi-lutram-wrapper-1.0";
   status = "okay";
   clock-names = "S_AXI_ACLK";
   xlnx,ip-name = "axi_lutram_wrapper";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x60000000 0x20000000>;
   clocks = <&clkc 15>;
   xlnx,name = "DMEM_0";
  };
  IMEM_0: axi_lutram_wrapper@50000000 {
   compatible = "xlnx,axi-lutram-wrapper-1.0";
   status = "okay";
   clock-names = "S_AXI_ACLK";
   xlnx,ip-name = "axi_lutram_wrapper";
  ...
  cpu_reset_0: gpio@41200000 {
   ...
   xlnx,name = "cpu_reset_0";
   xlnx,all-inputs = <0>;
  };
 };
};
# 4 "E:\\Vivado_projects\\RISCV_SOC\\vitis_v2\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "E:\\Vivado_projects\\RISCV_SOC\\vitis_v2\\platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
...
# 5 "E:\\Vivado_projects\\RISCV_SOC\\vitis_v2\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "zedboard";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x41200000 &cpu_reset_0 0x41200000 0x10000>,
         <0x50000000 &IMEM_0 0x50000000 0x10000000>,
         <0x60000000 &DMEM_0 0x60000000 0x20000000>,
