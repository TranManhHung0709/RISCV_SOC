...
(* CHECK_LICENSE_TYPE = "soc_riscv_v2_cpu_0_0,cpu,{}" *) (* CORE_GENERATION_INFO = "soc_riscv_v2_cpu_0_0,cpu,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=cpu,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
